...
class TestConvert(unittest.TestCase):
    ...
    def test_convert_all_hex_colour_with_quotes_text_in_the_content(self):
        converted_result = inspect.cleandoc("""
                <value>
                    <option value="FF0000" />
                    <option value="00FF00" />
        ...
        palette = inspect.cleandoc("""
                ...
                #0000ff
                """)
        self.assertEqual(converted_result, convert(theme=theme, theme_colour_format="hex_with_quotes", palette=palette))
